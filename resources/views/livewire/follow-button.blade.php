...
<div class="flex flex-col items-end gap-1">
    ...
    @if ($this->following)
        <button
            ...
            class="-my-1 flex h-9 shrink-0 items-center gap-1 rounded-md px-2.5 text-sm font-medium ring-1 ring-current/50 transition-opacity hover:opacity-80 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-current disabled:opacity-50"
        >
    ...
    @else
        ...
        <button
            ...
            wire:click="follow"
            wire:loading.attr="disabled"
            class="team-invert -my-1 flex h-9 shrink-0 items-center gap-1 rounded-md px-2.5 text-sm font-semibold shadow-sm transition-opacity hover:opacity-90 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-current disabled:opacity-50"
        >
